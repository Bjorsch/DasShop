...
namespace DasDAL
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="BrickKingdomDB")]
    ...
    partial void DeleteProductRelProduct(ProductRelProduct instance);
		...
		public DasDBDataContext() : 
				base(global::DasDAL.Properties.Settings.Default.BrickKingdomDBConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnCategoryIDChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Category_ProductRelCategory", Storage="_Category", ThisKey="CategoryID", OtherKey="CategoryID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Product_ProductRelCategory", Storage="_Product", ThisKey="ProductID", OtherKey="ProductID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
